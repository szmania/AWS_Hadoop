...
import mapReduce_earthquake.GetDailyForecast.DailyMapper;
import mapReduce_earthquake.GetDailyForecast.DailyReducer;

public class WeeklyForecast {

	public static class WeeklyForecastMapper extends MapReduceBase
	...
	public static class WeeklyForecastReducer extends MapReduceBase 
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		JobConf conf = new JobConf(GetDailyForecast.class); 
	      ...
	      conf.setMapperClass(WeeklyForecastMapper.class); 
	      conf.setReducerClass(WeeklyForecastReducer.class); 
